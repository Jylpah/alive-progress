...
Config = namedtuple(
    "Config",
    "title length max_cols spinner bar unknown force_tty disable manual "
    "enrich_print receipt receipt_text monitor elapsed stats "
    "title_length spinner_length refresh_secs monitor_end elapsed_end "
    "stats_end ctrl_c dual_line unit scale precision file rate_alpha",
)
...
def create_config():
    ...
    def lazy_init():
        ...
        validations.update(  # the ones the user can configure.
            ...
            rate_alpha=_float_input_factory(0, 1),
        )
